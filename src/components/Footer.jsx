    ...
    <footer className="footer">
      <div className="container footer-grid">
        <div className="footer-brand">
          ...
          <div className="footer-contact"><span><Phone size={15} /> +94 71 513 0130</span><span><Mail size={15} /> info@findmyuni.lk</span><span><MapPin size={15} /> Colombo, Sri Lanka</span></div>
        </div>
        ...
        <div className="footer-column footer-social"><h3>Follow us</h3><a href="#contact"><Camera size={17} /> Instagram</a><a href="#contact"><CirclePlay size={17} /> YouTube</a><a href="#contact"><LinkIcon size={17} /> LinkedIn</a><a className="footer-button" href="mailto:info@trinityinternational.com">Book free counselling</a></div>
      </div>
