    ...
    <main className="about-page">
      ...
      <section className="about-story-section">
        <div className="container story-grid">
          ...
          <article className="director-copy"><div className="director-heading"><h2>Director's Message</h2><Quote size={31} /></div><p>At Trinity International, we believe every student has a unique dream and the potential to achieve greatness. Our mission is to provide the right guidance, trustworthy support, and world-class opportunities to help you succeed globally. We are with you, every step of your journey.</p><strong>Dehemi Rubera</strong><small>— Director<br />Trinity International</small><img src={dehemiDirector} alt="Dehemi Rubera, Director of Trinity International" /></article>
        </div>
      </section>
